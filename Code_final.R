...
class(Median.age.both_2023)
hist(Median.age.both_2023, col = 'grey', main = "", freq = TRUE, xlim =c(0,60) , ylim = c(0,30), xlab = "Median age for both sexes in 2023",  ylab = "density", breaks = 15 )
...
class(Median.age.females_2023)
hist(Median.age.females_2023, col = 'grey', main = "", freq = TRUE, xlim =c(0,70) , ylim = c(0,50), xlab = "Median age for females in 2023",  ylab = "density", breaks = 15 )
...
class(Median.age.males_2023)
hist(Median.age.males_2023, col = 'grey', main = "", freq = TRUE, xlim =c(0,60) , ylim = c(0,25), xlab = "Median age for males in 2023",  ylab = "density",breaks = 15 )
